...
_BALANCE_SHEET_GUIDANCE = (
    ...
    "  BEFORE the allowance for credit/loan losses. This is typically the\n"
    "  LARGER number shown before any deduction.\n"
    ...
    "  This is the SMALLER number, the bottom line after deducting the\n"
    "  allowance. Filings often label it \"notes receivable, net\" or\n"
    "  \"vacation ownership notes receivable, net.\"\n"
    "- CRITICAL: if the excerpt shows only ONE receivable total qualified\n"
    "  by \"net\" (e.g., \"notes receivable, net: $X\"), return it as\n"
    "  net_receivables_mm and return null for gross_receivables_total_mm.\n"
    "  Do NOT copy the same number into both fields. Gross must be a\n"
    "  distinct, larger number disclosed separately.\n"
