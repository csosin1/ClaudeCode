...
Use this skill when working on daily reflection. (Placeholder — sharpen with the specific triggers: which tasks, which error modes, which project phases invoke it.)
